...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ___,        KC_A,       KC_S,       KC_D,        KC_F,       KC_G,             KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,  KC_QUOTE,
    ___,        KC_Z,       KC_X,       KC_C,        KC_V,       KC_B,             KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,  KC_RBRC,
                                        RUEN_TOG,    KC_SPC,     LA_NAV,           LA_SYM,     KC_LSFT,    LA_ALT
        ),
    ...
    ___,        KC_SCLN,    GRV,        KC_GRV,      QUOT,       KC_MINS,          KC_PLUS,    OS_SHFT,    OS_CTRL,    OS_ALT,     OS_CMD,   ___,
    ___,        BSL,        DPIPE,      SCLN,        KC_LBRC,    KC_UNDS,          KC_EQL,     KC_RBRC,    CLN,        PIPE,       KC_BSLS,  ___,
        ...
        [_NAV] = LAYOUT(
    ___,        ___,         ___,       ___,         ___,        ___,              ___,        ___,        ___,        ___,        ___,      ___, 
    ___,        SW_TAB,     SW_WIN,     TAB_L,       TAB_R,      KC_ESC,           ___,        KC_HOME,    KC_END,     KC_BSPC,    KC_DEL,   ___,
    ___,        OS_CMD,     OS_ALT,     OS_CTRL,     OS_SHFT,    KC_TAB,           KC_LEFT,    KC_DOWN,    KC_UP,      KC_RGHT,    ___,      ___,
    ___,        SPACE_L,    SPACE_R,    DF(_GAM),    KC_PSCR,    ___,              KC_ENT,     KC_PGUP,    KC_PGDN,    KC_QUOT,    KC_NUM,   ___,
